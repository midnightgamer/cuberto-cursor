...
var Cursor = /*#__PURE__*/function () {
  function Cursor(el) {
    ...
    this.Item = document.querySelectorAll('.hero-inner-link-item'); // this.Hero = document.querySelector('.hero-inner');
  ...
  _createClass(Cursor, [{
    ...
    value: function render() {
      ...
      this.cursorCnfigs.y.current = mouse.y; //    lerp

      for (var key in this.cursorCnfigs) {
        this.cursorCnfigs[key].previous = (0, _utils.lerp)(this.cursorCnfigs[key].previous, this.cursorCnfigs[key].current, this.cursorCnfigs[key].amt);
